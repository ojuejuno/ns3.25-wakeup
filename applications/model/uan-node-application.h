...
#ifndef UAN_NODE_APPLICATION_H
#define UAN_NODE_APPLICATION_H
 ...
 * \defgroup onoff UanNodeApplication
 *
...
*/
class UanNodeApplication : public Application 
{
public:
  /**
  ...
  */
  ...
  //void SetOnTimeScale(double min, double max);
...
private:
  ...
  uint32_t		   m_pktsPerTime; // number of packets generated per time cycle
  uint32_t         m_residualPkts;
  EventId          m_genEvent;
