 ...
 */
#ifndef UAN_NODE_APPLICATION_HELPER_H
#define UAN_NODE_APPLICATION_HELPER_H
 ...
 * on a set of nodes.
 */
class UanNodeApplicationHelper
{
public:
  /**
   * Create an UanNodeApplicationHelper to make it easier to work with OnOffApplications
   *
   ...
   *        to.
   */
  UanNodeApplicationHelper (std::string protocol, Address address);
